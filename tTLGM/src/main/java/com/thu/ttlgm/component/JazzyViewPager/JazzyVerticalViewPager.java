 ...
 */
public class JazzyVerticalViewPager extends VerticalViewPager{
    public static final String TAG = "JazzyVerticalViewPager";
    ...
    public JazzyVerticalViewPager(Context context) {
        this(context, null);
    }

    @SuppressWarnings("incomplete-switch")
    public JazzyVerticalViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
